...
describe("MarkdownPreview", () => {
  ...
  // KaTeX loads lazily (only when content contains `$$`), so math assertions
  // wait for the deferred plugin to arrive and re-render. While it loads, the
  // TeX source stays visible as `language-math` code — never a blank state.
